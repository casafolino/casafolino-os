...
import { getInbox, getInboxAll, getBucket, getQueueCount, getSenderCounts, searchInbox, getPartnerBundle } from "@/lib/bundle";
  ...
  return (
    <div className="app">
      ...
      <InboxClient
        ...
        view={v} scopeAll={scopeAll} queueCount={queueCount} senderCounts={senderCounts}
