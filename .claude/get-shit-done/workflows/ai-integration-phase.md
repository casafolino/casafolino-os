...
<required_reading>
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/ai-frameworks.md
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```bash
SELECTOR_MODEL=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-framework-selector --raw)
RESEARCHER_MODEL=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ai-researcher --raw)
DOMAIN_MODEL=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-domain-researcher --raw)
PLANNER_MODEL=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-planner --raw)
```

Check config:
```bash
AI_PHASE_ENABLED=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" config-get workflow.ai_integration_phase 2>/dev/null || echo "true")
```
...
```markdown
Read /Users/antoniofolino/casafolino-os/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/antoniofolino/casafolino-os/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/antoniofolino/casafolino-os/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/antoniofolino/casafolino-os/.claude/agents/gsd-eval-planner.md for instructions.
