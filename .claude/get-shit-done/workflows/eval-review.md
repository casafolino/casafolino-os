...
```bash
AUDITOR_MODEL=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/antoniofolino/casafolino-os/.claude/agents/gsd-eval-auditor.md for instructions.
