...
- **Global scope**: `/Users/antoniofolino/casafolino-os/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/antoniofolino/casafolino-os/.claude/notes/`)
...
2. Glob `/Users/antoniofolino/casafolino-os/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/antoniofolino/casafolino-os/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/antoniofolino/casafolino-os/.claude/notes/` — works in any directory
