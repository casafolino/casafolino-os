...
- Usage: Reference from command with `@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/antoniofolino/casafolino-os/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/antoniofolino/casafolino-os/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
