...
<!-- For checkpoint task examples and patterns, see @/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/antoniofolino/casafolino-os/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/antoniofolino/casafolino-os/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
