...
<reference>
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/user-profiling.md` to load:
