...
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/ios-scaffold.md
...
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @/Users/antoniofolino/casafolino-os/.claude/get-shit-done/references/checkpoints.md**
...
```bash
node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/Users/antoniofolino/casafolino-os/.claude/get-shit-done/templates/summary.md
...
node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
