...
<execution_context>
@/Users/antoniofolino/casafolino-os/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
- Check if SUMMARY.md exists; if so, read `status` from its frontmatter via:
  ```bash
  node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" frontmatter get .planning/quick/{dir}/SUMMARY.md --field status 2>/dev/null
  ```
...
5. Load context via:
   ```bash
   node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" init quick
   ```
...
Execute the quick workflow from @/Users/antoniofolino/casafolino-os/.claude/get-shit-done/workflows/quick.md end-to-end.
