...
Intel system is disabled. To activate:
  ...
  node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
