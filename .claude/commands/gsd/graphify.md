...
Knowledge graph is disabled. To activate:
  ...
  node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/Users/antoniofolino/casafolino-os/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
