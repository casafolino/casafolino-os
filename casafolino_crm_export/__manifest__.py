{
    ...
    'depends': ['crm', 'sale', 'mail', 'contacts', 'documents', 'project', 'account', 'stock', 'casafolino_mail', 'casafolino_project', 'casafolino_initiative', 'casafolino_initiative_dashboard'],
    'data': [
        ...
        'views/cf_fair_mail_template_views.xml',
